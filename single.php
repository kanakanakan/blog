...
<body>
    ...
    <main>
        <section class="content">
            <div class="single_inner">
                <ul class="page_list">
                    ...
                    <li>＞</li>
                    <li class="list"><?php the_title(''); ?></li>
                </ul>
        ...
        <a id="pagetop" href="<?php echo esc_url(get_permalink()); ?>#top">
            <img src="<?php echo get_theme_file_uri('/images/top_button.svg'); ?>" alt="ページの先頭へ">
        </a>
            ...
            links.forEach(link => {
                link.addEventListener("click", function(event) {
                    ...
                    if (targetId === "#first_heading") {
                        offset = 180; // #category のオフセット
                    } else if (targetId === "#second_heading") {
                        offset = 180; // #about のオフセット
